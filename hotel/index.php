...
<head>
    ...
    <title>Reservation System - Home</title>
...
<body>
    ...
    <header>
        <nav class="navbar">
            <div class="logo">
                <a href="index.php">
                    <img src="assets/img/logos.jpg" alt="Logo" style="width: 30px; height: auto;">
                </a>
            </div>
            <ul class="nav-links">
    ...
    <footer class="footer">
        <div class="footer-content">
            <a href="index.php">
                <img src="assets/img/logos.jpg" alt="Logo" style="width: 100px; height: auto;">
            </a>
        ...
        <div class="footer-info">
            <p>Development and Implementation of a Multi-platform Hotel Reservation System</p>
            <br>
            <p>Made with ❤️ by John Rey Cuaton, Keyse Flores, Yvenz Klyd Hayohay</p>
            <br>
