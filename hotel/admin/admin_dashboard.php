    ...
    <footer class="navbar navbar-expand-lg navbar-dark bg-primary footer" style="position: absolute; bottom: 0; width: 100%;">
        <div class="container d-flex flex-column align-items-center">
            <div class="footer-info text-center">
                <p style="font-weight: bold; margin: auto;">Development and Implementation of a Multi-platform Hotel Reservation System
                    <br>Made with ❤️ by John Rey Cuaton, Keyse Flores, Yvenz Klyd Hayohay   
                </p>
                <br>
